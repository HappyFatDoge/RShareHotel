 ...
 * ================================================
 */
public interface CleanHouseContract {
    //对于经常使用的关于UI的方法可以定义到IView中,如显示隐藏进度条,和显示文字消息
    interface View extends IView {
        void findMyCleanHouseResult(Boolean result, String tips, List<Hotel> list);
        void removeCleanHouseResult(Boolean result, String tips, Hotel hotel);
