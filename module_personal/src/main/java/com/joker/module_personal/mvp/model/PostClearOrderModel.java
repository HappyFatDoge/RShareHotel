 ...
 */
@ActivityScope
public class PostClearOrderModel extends BaseModel implements PostClearOrderContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PostClearOrderModel(IRepositoryManager repositoryManager) {
