...
public class GosDeviceListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (device.getNetStatus() == GizWifiDeviceNetStatus.GizDeviceOnline
            ...
            if (device.isLAN()) {
                holder.getLlLeft().setImageResource(R.mipmap.common_device_lan_online);
            } else {
                holder.getLlLeft().setImageResource(R.mipmap.common_device_remote_online);
            }
...
//                holder.getImgRight().setVisibility(View.VISIBLE);
            ...
            if (device.isLAN()) {
                holder.getLlLeft().setImageResource(R.mipmap.common_device_lan_offline);
            } else {
                holder.getLlLeft().setImageResource(R.mipmap.common_device_remote_offline);
            }
        }
...
//                } else {
//                    Toast.makeText(context, context.getString(R.string.public_app_name), Toast.LENGTH_SHORT).show();
//                }
            }
        });
        return view;
