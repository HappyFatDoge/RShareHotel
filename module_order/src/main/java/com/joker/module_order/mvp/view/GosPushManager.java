package com.joker.module_order.mvp.view;
...
import com.joker.module_order.mvp.view.receiver.BaiDuPushReceiver;
    ...
    public void bDPush() {
        ...
        if (BDPushAppKey != null) {
            if (TextUtils.isEmpty(BDPushAppKey) || BDPushAppKey.contains("your_bpush_api_key")) {
                GosBaseActivity.noIDAlert(context, "   请替换GOpenSource_AppKit/assets/appConfig.json中的参数定义...");
            } else {
