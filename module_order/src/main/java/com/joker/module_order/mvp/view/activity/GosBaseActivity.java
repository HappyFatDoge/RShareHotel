 ...
 */
public abstract class GosBaseActivity<P extends IPresenter> extends BaseActivity<P> {
    ...
    private static final String TAG = "GosBaseActivity";
    /**
     * 设备列表
     */
    ...
    private GizWifiSDKListener gizWifiSDKListener = new GizWifiSDKListener() {
        ...
        public void didDiscovered(GizWifiErrorCode result, List<GizWifiDevice> deviceList) {
            GosBaseActivity.this.didDiscovered(result, deviceList);
            Log.e(TAG, "didDiscovered=====----: 更新数据");
        }

        /** 用于用户匿名登录 */
        public void didUserLogin(GizWifiErrorCode result, String uid, String token) {
            GosBaseActivity.this.didUserLogin(result, uid, token);
        }

        /** 用于设备解绑 */
        public void didUnbindDevice(GizWifiErrorCode result, String did) {
            GosBaseActivity.this.didUnbindDevice(result, did);
        }

        /** 用于设备绑定 */
        public void didBindDevice(GizWifiErrorCode result, String did) {
            GosBaseActivity.this.didBindDevice(result, did);
        }

        /** 用于设备绑定（旧） */
        public void didBindDevice(int error, String errorMessage, String did) {
            GosBaseActivity.this.didBindDevice(error, errorMessage, did);
        }
...
//                break;
     ...
     * @param tips 提示内容
     */
    public static void noIDAlert(Context context, String tips) {
        TipsDialog tipsDialog = new TipsDialog(context);
        tipsDialog.show();
        tipsDialog.setTitle("提示");
        tipsDialog.setTipsContent(tips);
